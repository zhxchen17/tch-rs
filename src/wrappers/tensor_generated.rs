...
impl Tensor {
    ...
    pub fn internal_nested_view_from_jagged<T: Borrow<Tensor>>(
        &self, offsets: &Tensor, dummy: &Tensor, lengths: Option<T>, ragged_idx: i64
    ) -> Tensor {
    ...
    pub fn internal_nested_view_from_jagged_copy_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, offsets: &Tensor, dummy: &Tensor, lengths: Option<T>, ragged_idx: i64
    ) -> Tensor {
        self.f_internal_nested_view_from_jagged_copy_out(out, offsets, dummy, lengths, ragged_idx).unwrap()
    }
