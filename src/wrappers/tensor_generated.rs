...
impl Tensor {
    ...
    pub fn internal_assert_scalar<S: Into<Scalar>>(
        self_scalar: S, assert_msg: &str
    ) {
    ...
    pub fn internal_batch_norm_no_update<T: Borrow<Tensor>>(
        &self, weight: Option<T>, bias: Option<T>, running_mean: Option<T>, running_var: Option<T>, momentum: f64, eps: f64
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        self.f_internal_batch_norm_no_update(weight, bias, running_mean, running_var, momentum, eps).unwrap()
    }

    pub fn internal_batch_norm_no_update_out<T: Borrow<Tensor>>(
        &self, out0: &Tensor, out1: &Tensor, out2: &Tensor, out3: &Tensor, weight: Option<T>, bias: Option<T>, running_mean: Option<T>, running_var: Option<T>, momentum: f64, eps: f64
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        self.f_internal_batch_norm_no_update_out(out0, out1, out2, out3, weight, bias, running_mean, running_var, momentum, eps).unwrap()
    }
    ...
    pub fn internal_batch_norm_with_update<T: Borrow<Tensor>>(
        ...
        self.f_internal_batch_norm_with_update(weight, bias, running_mean, running_var, momentum, eps).unwrap()
    }

    pub fn internal_batch_norm_with_update_functional<T: Borrow<Tensor>>(
        &self, weight: Option<T>, bias: Option<T>, running_mean: &Tensor, running_var: &Tensor, momentum: f64, eps: f64
    ) -> (Tensor, Tensor, Tensor, Tensor, Tensor, Tensor) {
        self.f_internal_batch_norm_with_update_functional(weight, bias, running_mean, running_var, momentum, eps).unwrap()
    }

    pub fn internal_batch_norm_with_update_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, save_mean: &Tensor, save_invstd: &Tensor, reserve: &Tensor, weight: Option<T>, bias: Option<T>, running_mean: &Tensor, running_var: &Tensor, momentum: f64, eps: f64
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        self.f_internal_batch_norm_with_update_out(out, save_mean, save_invstd, reserve, weight, bias, running_mean, running_var, momentum, eps).unwrap()
    }
    ...
    pub fn internal_efficient_attention_backward<T: Borrow<Tensor>>(
        grad_out_: &Tensor, query: &Tensor, key: &Tensor, value: &Tensor, bias: Option<T>, out: &Tensor, cu_seqlens_q: Option<T>, cu_seqlens_k: Option<T>, max_seqlen_q: i64, max_seqlen_k: i64, logsumexp: &Tensor, dropout_p: f64, philox_seed: &Tensor, philox_offset: &Tensor, custom_mask_type: i64, bias_requires_grad: bool, scale: impl Into<Option<f64>>, num_splits_key: impl Into<Option<i64>>, window_size: impl Into<Option<i64>>, shared_storage_dqdkdv: bool
    ) -> (Tensor, Tensor, Tensor, Tensor) {
        Tensor::f_internal_efficient_attention_backward(grad_out_, query, key, value, bias, out, cu_seqlens_q, cu_seqlens_k, max_seqlen_q, max_seqlen_k, logsumexp, dropout_p, philox_seed, philox_offset, custom_mask_type, bias_requires_grad, scale, num_splits_key, window_size, shared_storage_dqdkdv).unwrap()
    }
    ...
    pub fn internal_flash_attention_backward(
        grad_out: &Tensor, query: &Tensor, key: &Tensor, value: &Tensor, out: &Tensor, logsumexp: &Tensor, cum_seq_q: &Tensor, cum_seq_k: &Tensor, max_q: i64, max_k: i64, dropout_p: f64, is_causal: bool, philox_seed: &Tensor, philox_offset: &Tensor, scale: impl Into<Option<f64>>, window_size_left: impl Into<Option<i64>>, window_size_right: impl Into<Option<i64>>
    ) -> (Tensor, Tensor, Tensor) {
        Tensor::f_internal_flash_attention_backward(grad_out, query, key, value, out, logsumexp, cum_seq_q, cum_seq_k, max_q, max_k, dropout_p, is_causal, philox_seed, philox_offset, scale, window_size_left, window_size_right).unwrap()
    }
    ...
    pub fn internal_functional_assert_scalar<S: Into<Scalar>>(
        self_scalar: S, assert_msg: &str, dep_token: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_fused_sdp_choice<T: Borrow<Tensor>>(
        query: &Tensor, key: &Tensor, value: &Tensor, attn_mask: Option<T>, dropout_p: f64, is_causal: bool, scale: impl Into<Option<f64>>, enable_gqa: bool
    ) -> i64 {
        Tensor::f_internal_fused_sdp_choice(query, key, value, attn_mask, dropout_p, is_causal, scale, enable_gqa).unwrap()
    }
    ...
    pub fn internal_linalg_eigvals(
        &self, 
    ) -> Tensor {
    ...
    pub fn internal_nested_view_from_jagged<T: Borrow<Tensor>>(
        &self, offsets: &Tensor, dummy: &Tensor, lengths: Option<T>, ragged_idx: i64, min_seqlen: Option<T>, max_seqlen: Option<T>
    ) -> Tensor {
        self.f_internal_nested_view_from_jagged(offsets, dummy, lengths, ragged_idx, min_seqlen, max_seqlen).unwrap()
    }

    pub fn internal_nested_view_from_jagged_copy<T: Borrow<Tensor>>(
        &self, offsets: &Tensor, dummy: &Tensor, lengths: Option<T>, ragged_idx: i64, min_seqlen: Option<T>, max_seqlen: Option<T>
    ) -> Tensor {
        self.f_internal_nested_view_from_jagged_copy(offsets, dummy, lengths, ragged_idx, min_seqlen, max_seqlen).unwrap()
    }

    pub fn internal_nested_view_from_jagged_copy_out<T: Borrow<Tensor>>(
        &self, out: &Tensor, offsets: &Tensor, dummy: &Tensor, lengths: Option<T>, ragged_idx: i64, min_seqlen: Option<T>, max_seqlen: Option<T>
    ) -> Tensor {
        self.f_internal_nested_view_from_jagged_copy_out(out, offsets, dummy, lengths, ragged_idx, min_seqlen, max_seqlen).unwrap()
    }
    ...
    pub fn internal_scaled_dot_product_attention_math<T: Borrow<Tensor>>(
        query: &Tensor, key: &Tensor, value: &Tensor, attn_mask: Option<T>, dropout_p: f64, is_causal: bool, dropout_mask: Option<T>, scale: impl Into<Option<f64>>, enable_gqa: bool
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_scaled_dot_product_attention_math(query, key, value, attn_mask, dropout_p, is_causal, dropout_mask, scale, enable_gqa).unwrap()
    }
    ...
    pub fn internal_scaled_dot_product_attention_math_for_mps<T: Borrow<Tensor>>(
        ...
        Tensor::f_internal_scaled_dot_product_attention_math_for_mps(query, key, value, attn_mask, dropout_p, is_causal, dropout_mask, scale).unwrap()
    }
    ...
    pub fn internal_scaled_dot_product_flash_attention_for_cpu<T: Borrow<Tensor>>(
        query: &Tensor, key: &Tensor, value: &Tensor, dropout_p: f64, is_causal: bool, attn_mask: Option<T>, scale: impl Into<Option<f64>>
    ) -> (Tensor, Tensor) {
        Tensor::f_internal_scaled_dot_product_flash_attention_for_cpu(query, key, value, dropout_p, is_causal, attn_mask, scale).unwrap()
    }

    pub fn internal_scaled_dot_product_flash_attention_for_cpu_backward<T: Borrow<Tensor>>(
        grad_out: &Tensor, query: &Tensor, key: &Tensor, value: &Tensor, out: &Tensor, logsumexp: &Tensor, dropout_p: f64, is_causal: bool, attn_mask: Option<T>, scale: impl Into<Option<f64>>
    ) -> (Tensor, Tensor, Tensor) {
        Tensor::f_internal_scaled_dot_product_flash_attention_for_cpu_backward(grad_out, query, key, value, out, logsumexp, dropout_p, is_causal, attn_mask, scale).unwrap()
    }
    ...
    pub fn internal_sparse_compressed_tensor_with_dims(
        nnz: i64, dense_dim: i64, size: impl IntList, blocksize: impl IntList, index_dtype: Kind, options: (Kind, Device)
    ) -> Tensor {
        Tensor::f_internal_sparse_compressed_tensor_with_dims(nnz, dense_dim, size, blocksize, index_dtype, options).unwrap()
    }
    ...
    pub fn internal_sparse_semi_structured_apply(
        &self, thread_masks: &Tensor
    ) -> (Tensor, Tensor) {
        self.f_internal_sparse_semi_structured_apply(thread_masks).unwrap()
    }

    pub fn internal_sparse_semi_structured_apply_dense(
        &self, thread_masks: &Tensor
    ) -> Tensor {
        self.f_internal_sparse_semi_structured_apply_dense(thread_masks).unwrap()
    }
    ...
    pub fn internal_sparse_semi_structured_mm(
        mat1: &Tensor, mat1_meta: &Tensor, mat2: &Tensor, out_dtype: impl Into<Option<Kind>>
    ) -> Tensor {
    ...
    pub fn internal_sparse_semi_structured_tile(
        &self, algorithm: &str, use_cutlass: bool
    ) -> (Tensor, Tensor, Tensor, Tensor, Tensor) {
        self.f_internal_sparse_semi_structured_tile(algorithm, use_cutlass).unwrap()
    }
    ...
    pub fn internal_test_parallel_materialize(
        &self, num_parallel: i64, skip_first: bool
    ) -> Tensor {
    ...
    pub fn internal_unsafe_masked_index<T: Borrow<Tensor>, S: Into<Scalar>>(
        &self, mask: &Tensor, indices: &[Option<T>], fill: S
    ) -> Tensor {
    ...
    pub fn internal_unsafe_masked_index_put_accumulate<T: Borrow<Tensor>>(
        &self, mask: &Tensor, indices: &[Option<T>], values: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_weight_int8pack_mm(
        &self, mat2: &Tensor, scales: &Tensor
    ) -> Tensor {
    ...
    pub fn internal_wrapped_linear_prepack(
        weight: &Tensor, weight_scale: &Tensor, weight_zero_point: &Tensor, bias: &Tensor
    ) -> Tensor {
        Tensor::f_internal_wrapped_linear_prepack(weight, weight_scale, weight_zero_point, bias).unwrap()
    }

    pub fn internal_wrapped_quantized_linear_prepacked(
        &self, input_scale: &Tensor, input_zero_point: &Tensor, packed_weight: &Tensor, output_scale: &Tensor, output_zero_point: &Tensor, out_channel: i64
    ) -> Tensor {
        self.f_internal_wrapped_quantized_linear_prepacked(input_scale, input_zero_point, packed_weight, output_scale, output_zero_point, out_channel).unwrap()
    }
    ...
    pub fn mkldnn_reorder_conv3d_weight(
        ...
        self.f_mkldnn_reorder_conv3d_weight(padding, stride, dilation, groups, input_size).unwrap()
    }

    pub fn mkldnn_reorder_conv3d_weight_out(
        &self, out: &Tensor, padding: impl IntList, stride: impl IntList, dilation: impl IntList, groups: i64, input_size: impl IntListOption
    ) -> Tensor {
        self.f_mkldnn_reorder_conv3d_weight_out(out, padding, stride, dilation, groups, input_size).unwrap()
    }
    ...
    pub fn pad_sequence<T: Borrow<Tensor>>(
        sequences: &[T], batch_first: bool, padding_value: f64, padding_side: &str
    ) -> Tensor {
    ...
    pub fn rms_norm<T: Borrow<Tensor>>(
        &self, normalized_shape: impl IntList, weight: Option<T>, eps: impl Into<Option<f64>>
    ) -> Tensor {
    ...
    pub fn scaled_dot_product_attention<T: Borrow<Tensor>>(
        ...
        Tensor::f_scaled_dot_product_attention(query, key, value, attn_mask, dropout_p, is_causal, scale, enable_gqa).unwrap()
    }
